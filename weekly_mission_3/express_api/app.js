...
app.get('/v1/explorers/:id', (req, res) => {
    ...
    const explorer = {id : 1, name: "MIguel"}
    res.status(200).json(explorer)

})
app.post('/v1/explorers', (req, res) =>{
    console.log(`Api Explorers POST reques ${new Date()}`)
    const resquetBody= req.body //Parametros de un cliente
...
app.put('/v1/explorers/:id', (req, res) => {
    ...
    const resquestBody = req.body //Parametros de un cliente
...
app.delete('/v1/explorers/:id', (req, res) => {
    ...
    const requestBody = req.body // Parametros para un cliente
